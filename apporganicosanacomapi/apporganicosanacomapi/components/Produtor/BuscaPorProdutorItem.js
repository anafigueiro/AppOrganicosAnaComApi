...
//Import da segunda aba da página - vai buscar por item do produtor
...
export default function BuscaPorProdutorItem({ navigation, route }) {
  ...
  const loadData = async () => {
    try {
      ...
      if (param !== null) {
        ...
        console.log("entrou")
        response = await ConnectAPI.call('produtor-produto/0');
      }
